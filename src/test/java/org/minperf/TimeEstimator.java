...
//            double r = Math.log(b.generateNanos);
  ...
  public static double getExpectedEvaluationSupplementalHashCalls(int leafSize,
  ...
  private static double getExpectedEvaluationSupplementalHashCalls(Settings s, int size,
      int indent) {
    if (size <= 1) {
      return 0;
    }
