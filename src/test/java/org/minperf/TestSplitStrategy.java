...
public class TestSplitStrategy {
  ...
  public void test() {
    ...
    System.out.println();
    System.out.println(
        "Using the \"best\" split strategy for everything (pareto) ================");
...
//        System.out.println(splitList[averageBucketSize - 1]);
  ...
  private void showSplitStrategy(int leafSize, int maxBucketSize, boolean useBest,
...
//            System.out.println("split " + s);
  ...
  public static void main2(String... args) {
    for (int size = 2; size < 300; size += 2) {
      ...
      System.out.println(size + " " + p + " " + p2 + " diff " + (100. / p * p2 - 100) + " " + " "
  ...
  static class Split {
    ...
    public String toString() {
      return String.format(Locale.ENGLISH,
          "size %d eval %3.2f gen %3.2f space %3.2f (bits/key: %3.2f) parts %s", size, evaluation,
