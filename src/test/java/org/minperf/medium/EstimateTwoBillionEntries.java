...
public class EstimateTwoBillionEntries {
  ...
  public static void main(String... args) {
    ...
    System.out.println(
        "steps: " + steps + " perStep: " + perStep + " total " + (long) perStep * steps);
    int bitsBuild = 64; // (int) (remainBits / perStep);
    System.out.println(
        "bits per step " + bitsPerStep + " " + bitsPerStep / 8 / 1024 / 1024 + " mb");
    System.out.println("mphf per step " + mphfBitsPerKey * perStep + " "
        + mphfBitsPerKey * perStep / 8 / 1024 / 1024 + " mb");
