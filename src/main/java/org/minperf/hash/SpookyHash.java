...
public class SpookyHash {
  ...
  static void hash128x32(byte[] key, int offset, int len, int seed, LongPair out) {
    ...
    for (; offset < end32; offset += 32) {
      ...
      // shortMix(a,b,c,d);
      c = Long.rotateLeft(c, 50);
      c += d;
      a ^= c;
      d = Long.rotateLeft(d, 52);
      d += a;
      b ^= d;
      a = Long.rotateLeft(a, 30);
      a += b;
      c ^= a;
      b = Long.rotateLeft(b, 41);
      b += c;
      d ^= b;
      c = Long.rotateLeft(c, 54);
      c += d;
      a ^= c;
      d = Long.rotateLeft(d, 48);
      d += a;
      b ^= d;
      a = Long.rotateLeft(a, 38);
      a += b;
      c ^= a;
      b = Long.rotateLeft(b, 37);
      b += c;
      d ^= b;
      c = Long.rotateLeft(c, 62);
      c += d;
      a ^= c;
      d = Long.rotateLeft(d, 34);
      d += a;
      b ^= d;
      a = Long.rotateLeft(a, 5);
      a += b;
      c ^= a;
    ...
    // shortEnd(a,b,c,d);
    d ^= c;
    c = Long.rotateLeft(c, 15);
    d += c;
    a ^= d;
    d = Long.rotateLeft(d, 52);
    a += d;
    b ^= a;
    a = Long.rotateLeft(a, 26);
    b += a;
    c ^= b;
    b = Long.rotateLeft(b, 51);
    c += b;
    d ^= c;
    c = Long.rotateLeft(c, 28);
    d += c;
    a ^= d;
    d = Long.rotateLeft(d, 9);
    a += d;
    b ^= a;
    a = Long.rotateLeft(a, 47);
    b += a;
    c ^= b;
    b = Long.rotateLeft(b, 54);
    c += b;
    d ^= c;
    c = Long.rotateLeft(c, 32);
    d += c;
    a ^= d;
    d = Long.rotateLeft(d, 25);
    a += d;
    b ^= a;
    a = Long.rotateLeft(a, 63);
    b += a;
